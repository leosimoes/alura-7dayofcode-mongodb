...
21. Criar endpoint PUT `/avengers/nickname/:nickname`:
- Adicionar o código em **index.js**:
```javascript
...
22. Criar endpoint PUT `/avengers/realname/:realname`:
- Adicionar o código em **index.js**:
```javascript
...
23. Criar endpoint GET `/avengers/pages`:
- Adicionar o código em **index.js**:
```javascript
...
```
- Alterar a rota  da busca por id de `/avengers/:id/` para `/avengers/id/:id/`;
- Testar buscas por páginas com o navegador (ou Postman):
